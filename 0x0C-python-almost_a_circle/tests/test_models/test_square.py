#!/usr/bin/python3
"""Defines unittests for models/square.py class
"""
import io
import sys
import unittest
...
class TestSquare_instantiation(unittest.TestCase):
    """Unittest for testing instantiation of Square class"""
...
class TestSquare_size(unittest.TestCase):
    """Unittest for testing size initialization of Square class"""
...
class TestSquare_area(unittest.TestCase):
    """Unittest for testing area method of Square class"""
...
class TestSquare_stdout(unittest.TestCase):
    """Unittest for testing __str__ and display methods of Square class"""
    ...
    def capture_stdout(sq, method):
        ...
        Args:
            sq (Square): Squar ot print to stdout
...
class TestSquare_update_args(unittest.TestCase):
    """Unittest for testing update args method of Square class"""
...
class TestSquare_update_kwargs(unittest.TestCase):
    """Unittest for testing update kwargs method of Square class"""
...
class TestSquare_to_dictionary(unittest.TestCase):
    """Unittest for testing to_dictionary method of Square class"""
